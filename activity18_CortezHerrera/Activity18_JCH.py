#Jennifer Cortez Herrera: activity 18
...
if age == 5 and gender == "M" or gender == "m":
    ...
    print("Any other rathew than 5")


print("\n\n------------------ FOR LOOP ------------------")
#ex 4: for loop basics
for x in range(1,5):
    print("Counting: ", x)
    
    
#ex 5: for loops w/ 3 arguments
for y in range(2,30,3):    #note: starting number, ending number (exclusive), incremenet number
    print("y = ", y)
...
#ex 9: nesting for loop and if statement
